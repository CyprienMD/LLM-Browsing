...
CATEGORY = "laptops"
PROCESS_COUNT = 3
with DBInterface("amazon") as original_interface:
    with DBInterface(CATEGORY) as db_interface:
        ...
        for index, item in tqdm(items.iterrows()):
            ...
            for index, review in reviews.iterrows():
                ...
                insert_query = f"""INSERT INTO public.attributes(name, value, element_id) VALUES 
                        ('helpful_true', '{review.vote}' , {review_element_id}),
